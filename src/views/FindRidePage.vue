<template>
    <div class="min-h-screen bg-gray-50 py-6 sm:py-8 lg:py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 lg:p-8">
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Find a Ride</h1>
                ...
                <div class="mb-4 sm:mb-6">
                    ...
                    <div class="flex gap-2">
                        <div class="flex-1">
                            <AddressSearchBar v-model="origin" :placeholder="t('fromPlaceholder')" :min-chars="2"
                        ...
                        <button @click="getUserLocation" :disabled="isGettingLocation"
                            class="px-3 sm:px-4 py-2.5 sm:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition duration-200 flex items-center justify-center flex-shrink-0"
                ...
                <div class="mb-4 sm:mb-6">
                    ...
                    <AddressSearchBar v-model="destination" :placeholder="t('toPlaceholder')" :min-chars="2"
                        :debounce-delay="300" :max-results="10" :user-location="origin"
                        @select="handleDestinationSelect" @clear="handleDestinationClear" />
                </div>

                <div v-if="origin || destination" class="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
                    <div v-if="origin"
                        class="p-3 sm:p-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg">
                    ...
                    <div v-if="destination"
                        class="p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg">
                        <h3 class="text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                ...
                <button v-if="origin && destination" @click="findRide" :disabled="isSearching"
                    class="w-full mt-4 sm:mt-6 px-4 sm:px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition duration-200 text-sm sm:text-base">
