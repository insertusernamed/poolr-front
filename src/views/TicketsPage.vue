    ...
    <div class="max-w-5xl mx-auto my-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <span v-if="tickets.length > 0"
                ...
                {{ tickets.length }} {{ t("tickets.upcoming") }}
            </span>
        </div>
        ...
        <div v-if="ticketStore.loading"
            ...
            <p class="text-gray-500 font-medium">{{ t("tickets.loading") }}</p>
        </div>
        ...
        <div v-else-if="tickets.length === 0"
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2">{{ t("tickets.noTicketsYet") }}</h3>
        ...
        <div v-else class="grid gap-6 sm:grid-cols-1 lg:grid-cols-2">
            <div v-for="ticket in tickets" :key="ticket.ticketId"
                ...
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                    <div>
                        <p class="text-xs font-bold text-blue-600 uppercase tracking-wider mb-1">{{ t("tickets.departure") }}</p>
                    ...
                    <div class="text-right">
                        <div
                            ...
                            <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{{ t("tickets.confirmationCode") }}</span>
                ...
                <div class="p-6 flex-grow">
                    ...
                    <div class="relative pl-4 space-y-8 mb-8">
                        ...
                        <div class="relative flex items-start">
                            ...
                            <div class="ml-6">
                                <p class="text-xs font-semibold text-gray-400 uppercase">{{ t("tickets.from") }}</p>
                        ...
                        <div class="relative flex items-start">
                            ...
                            <div class="ml-6">
                                <p class="text-xs font-semibold text-gray-400 uppercase">{{ t("tickets.to") }}</p>
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 flex items-center justify-between border border-gray-100">
                        ...
                        <div v-if="ticket.rideDistanceKm" class="text-right">
                            <p class="text-xs text-gray-400">{{ t("tickets.distance") }}</p>
                ...
                <div
                    ...
                    <span>{{ t("tickets.bookedAt") }} {{ formatDate(ticket.createdAt) }}</span>
                </div>
            </div>
        </div>
    </div>
...
const formatDeparture = (startTime) => {
    ...
    // Format: Nov 27 • 7:22 AM (uses the browser's locale)
