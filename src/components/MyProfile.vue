        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm bg-sky-900">
            <form @submit.prevent="submitForm" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input disabled v-model="localUserData.vehicleModel" id="vehicleModel" type="tel"
                            name="vehicleModel"
                            class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                    </div>
                </div>
                ...
                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Update</button>
                </div>
            </form>
        </div>
    </div>
